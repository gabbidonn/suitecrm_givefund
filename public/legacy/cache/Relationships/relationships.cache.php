 ...
 $relationships = array (
  ...
  array (
    ...
    array (
      'gfr_events_leads_1' => 
      array (
        'lhs_module' => 'gfr_Events',
        'lhs_table' => 'gfr_events',
        'lhs_key' => 'id',
        'rhs_module' => 'Leads',
        'rhs_table' => 'leads',
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'gfr_events_leads_1_c',
        'join_key_lhs' => 'gfr_events_leads_1gfr_events_ida',
        'join_key_rhs' => 'gfr_events_leads_1leads_idb',
      ),
    ),
    'table' => 'gfr_events_leads_1_c',
    'fields' => 
    array (
      0 => 
      array (
      ...
      4 => 
      array (
        'name' => 'gfr_events_leads_1leads_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      ...
      1 => 
      array (
        'name' => 'gfr_events_leads_1_ida1',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'gfr_events_leads_1gfr_events_ida',
        ),
      ),
      2 => 
      array (
        'name' => 'gfr_events_leads_1_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'gfr_events_leads_1leads_idb',
        ),
      ),
    ),
    'lhs_module' => 'gfr_Events',
