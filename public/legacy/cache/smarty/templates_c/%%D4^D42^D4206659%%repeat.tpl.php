<?php /* Smarty version 2.6.33, created on 2023-08-11 22:51:56
...
<table class="edit view" width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="5%" valign="top" scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_TYPE']; ?>
:</td>
	...
	<tr id="repeat_interval_row" style="display: none;">
		<td width="5%" valign="top" scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_INTERVAL']; ?>
:</td>
		<td width="45%" valign="top">
	...
	<tr id="repeat_end_row" style="display: none;">
		<td width="5%" valign="top" scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_END']; ?>
:</td>
		<td width="45%" valign="top">
			<div class="repeat-after">
				<input type="radio" name="repeat_end_type" value="number" id="repeat_count_radio" checked onclick="toggle_repeat_end();" style="position: relative;"> <?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_END_AFTER']; ?>
 
				<input type="input" size="3" name="repeat_count" value="10"> <?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_OCCURRENCES']; ?>

			</div>
			<div class="repeat-by">					
				<input type="radio" name="repeat_end_type" id="repeat_until_radio" value="date" onclick="toggle_repeat_end();" style="position: relative;"> <?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_END_BY']; ?>
...
,
	...
	<tr id="repeat_dow_row" style="display: none;">
		<td width="5%" valign="top" scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_REPEAT_DOW']; ?>
:</td>
		<td width="45%" valign="top">
