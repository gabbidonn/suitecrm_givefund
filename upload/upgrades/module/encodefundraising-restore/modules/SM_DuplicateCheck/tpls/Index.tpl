	...
	<div class="widget_header row-fluid">
		...
		<div>
			<div class='row' style="display: flex; align-items: center;">
				...
				<div class="row" style="display: flex; align-items: center;">
				<div class='col-md-5'>
					<h5 style="float:left;">Duplicate Check Rule For</h5>
				</div>
				<div class='col-md-7'>
					<select class="select2 form-control" id="layoutEditorModules" onchange="getModuleID()" name="layoutEditorModules">
				...
				<div class="col-md-4 col-md-offset-2">
					<label class="fancy-checkbox" style="display: flex; align-items: center;">
                                                ...
                                                <i style="margin-left: 5px;" class="fa fa-toggle-on fa-2x fa-rotate-180 inactive unchecked" aria-hidden="true"></i>
                                                <i style="margin-left: 5px;" class="fa fa-toggle-on active fa-2x checked" aria-hidden="true"></i>
                                        </label>
				</div>
			</div>
			</div>
			...
			<br>
				<hr class='hr-dotted' style='width:100%;'>
					<div class="tab-content layoutContent padding20 themeTableColor overflowVisible">
						<div class="tab-pane active" id="detailViewLayout" style="display: inline-block; width: 100%;">
						...
						<div class="row" style="margin: 15px 0px;">
							<div class="col-md-4">
								Click <i class="fa fa-exchange"></i> to choose what to check in this module
							</div>
							<div class="col-md-3">
							   <span id="crosscheck">
								<label style="margin-right: 5px;">For CrossCheck</label>
								<input type="checkbox" name="ischecked" style="top:5px" id="ischecked" {if $CROSSCHECKVALUE eq 1} checked="yes"{/if}>
								<i style="margin-left: 5px;" id="crosscheckhelp" data-original-title = "Content" rel = "tooltip" title="Check Duplicates across Contacts , Leads and Organization for Email and Phone Field" class="fa fa-question-circle" aria-hidden="true"></i>
								</span>
							</div>
						</div>
						...
						<div id='moduleBlocks' style='display:block;'>
							...
							<div class="col-sm-6 marginLeftZero">
							<div class="map-row" style="border: 1px solid #e8e8e8; padding: 15px;">
					...
					<div class="row" style="margin-top: 10px; display: inline-block; width: 100%;">
						<button class="btn btn-default" onclick="window.location.reload();" style="float:right" value="Save">Cancel</button><button class="btn btn-success" name="savebutton" style="float:right" type="submit" value="Save">Save</button>
					</div>
				</div>
			</div>
		</div>
