<?php /* Smarty version 2.6.31, created on 2019-09-25 08:02:00
         compiled from cache/themes/SuiteP/modules/Leads/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 147, false),array('modifier', 'substr', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 386, false),array('modifier', 'to_url', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 388, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 1200, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 1200, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 1200, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 81, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 90, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 154, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 894, false),)), $this); ?>
...
<?php if (! $this->_tpl_vars['fields']['event_name_c']['hidden']): ?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['event_name_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['event_name_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['charity_name_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['charity_name_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['charity_name_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['event_date_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['event_date_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['event_date_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['event_date_c']['value']); ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['event_date_c']['name']; ?>
...
<div class="panel-body panel-collapse collapse in panelContainer" id="top-panel-0"  data-id="LBL_CONTACT_INFORMATION">
<div class="tab-content">
<!-- TAB CONTENT -->
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="event_type_c"  >

<?php if (! $this->_tpl_vars['fields']['event_type_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['event_type_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['event_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['event_type_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['event_type_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['event_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['event_type_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['event_type_c']['options'][$this->_tpl_vars['fields']['event_type_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="date" field="date_sent_c"  >

<?php if (! $this->_tpl_vars['fields']['date_sent_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['date_sent_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_sent_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_sent_c']['value']); ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['date_sent_c']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="text" field="status_description" colspan='3' >
