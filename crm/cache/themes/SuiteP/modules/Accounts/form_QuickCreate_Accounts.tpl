...
addToValidate('form_QuickCreate_Accounts', 'status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'charity_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CHARITY_NAME' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'event_website_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_EVENT_WEBSITE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'event_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EVENT_NAME' module='Accounts' for_js=true}{literal}' );
