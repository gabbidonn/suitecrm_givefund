...
class getIndexControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.E5Q7GzA'] ?? $container->load('get_ServiceLocator_E5Q7GzAService'))->withContext('App\\Engine\\Controller\\IndexController', $container));
