...
{/if}  
<input type='text' name='{$fields.venue_c.name}' 
id='{$fields.venue_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'venue_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_VENUE' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'event_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EVENT_NAME' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'charity_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CHARITY_NAME' module='Opportunities' for_js=true}{literal}' );
