...
<input type='text' name='{$fields.first_name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='full_name_advanced'>{sugar_translate label='LBL_NAME' module='Leads'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.account_name_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='charity_name_c_advanced'>{sugar_translate label='LBL_CHARITY_NAME' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.charity_name_c_advanced.value) <= 0}
{assign var="value" value=$fields.charity_name_c_advanced.default_value }
{else}
{assign var="value" value=$fields.charity_name_c_advanced.value }
{/if}  
<input type='text' name='{$fields.charity_name_c_advanced.name}' 
    id='{$fields.charity_name_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                            </div>
        </div>
