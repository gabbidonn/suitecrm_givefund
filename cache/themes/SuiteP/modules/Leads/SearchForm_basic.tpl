...
value="1" title='' tabindex="" {$checked} >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='charity_name_c_basic' >{sugar_translate label='LBL_CHARITY_NAME' module='Leads'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.charity_name_c_basic.value) <= 0}
{assign var="value" value=$fields.charity_name_c_basic.default_value }
{else}
{assign var="value" value=$fields.charity_name_c_basic.value }
{/if}  
<input type='text' name='{$fields.charity_name_c_basic.name}' 
    id='{$fields.charity_name_c_basic.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
		</div>
		<div class="search-clear"></div>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='account_name_basic'> {sugar_translate label='LBL_ACCOUNT_NAME' module='Leads'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.account_name_basic.value) <= 0}
{assign var="value" value=$fields.account_name_basic.default_value }
{else}
{assign var="value" value=$fields.account_name_basic.value }
{/if}  
<input type='text' name='{$fields.account_name_basic.name}' 
    id='{$fields.account_name_basic.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
		</div>
		<div class="search-clear"></div>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='event_name_c_basic' >{sugar_translate label='LBL_EVENT_NAME' module='Leads'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.event_name_c_basic.value) <= 0}
{assign var="value" value=$fields.event_name_c_basic.default_value }
{else}
{assign var="value" value=$fields.event_name_c_basic.value }
{/if}  
<input type='text' name='{$fields.event_name_c_basic.name}' 
    id='{$fields.event_name_c_basic.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
		</div>
		<div class="search-clear"></div>
