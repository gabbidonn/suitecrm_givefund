...
{if !$fields.event_type_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.event_type_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.event_type_c.name}" value="{ $fields.event_type_c.options }">
{ $fields.event_type_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.event_type_c.name}" value="{ $fields.event_type_c.value }">
{ $fields.event_type_c.options[$fields.event_type_c.value]}
{/if}
{/if}
...
{if !$fields.date_sent_c.hidden}
{counter name="panelFieldCount" print=false}


{if strlen($fields.date_sent_c.value) <= 0}
{assign var="value" value=$fields.date_sent_c.default_value }
{else}
{assign var="value" value=$fields.date_sent_c.value }
{/if}
<span class="sugar_field" id="{$fields.date_sent_c.name}">{$value}</span>
{/if}
