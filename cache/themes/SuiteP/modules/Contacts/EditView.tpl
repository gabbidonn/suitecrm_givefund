...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOMFIELD1' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.customfield1_c.value) <= 0}
{assign var="value" value=$fields.customfield1_c.default_value }
{else}
{assign var="value" value=$fields.customfield1_c.value }
{/if}  
<input type='text' name='{$fields.customfield1_c.name}' 
id='{$fields.customfield1_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EVENT_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CHARITY_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
addToValidate('EditView', 'event_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EVENT_NAME' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'customfield1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOMFIELD1' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'charity_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CHARITY_NAME' module='Contacts' for_js=true}{literal}' );
